...
type VethPair struct {
	...
	P1IPAddress string `yaml:"p1_ip_address" mapstructure:"p1_ip_address" validate:"ipv4"`
	P2Namespace string `mapstructure:"p2_ns"`
	P2Name      string `mapstructure:"p2_name"`
	P2IPAddress string `yaml:"p2_ip_address" mapstructure:"p2_ip_address" validate:"ipv4"`
}
